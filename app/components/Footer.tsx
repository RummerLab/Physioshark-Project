      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-xl font-bold mb-4">About Physioshark</h3>
            <p className="text-gray-400 mb-4">
              The Physioshark project investigates how climate change impacts the physiology 
              of newborn and juvenile reef sharks, working towards their conservation and protection.
            </p>
            <div className="flex space-x-4">
              ...
              <a 
                href="https://instagram.com/physioshark"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-white transition-colors"
              >
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/our-team" className="text-gray-400 hover:text-white transition-colors">
                  Our Team
                </Link>
              </li>
              <li>
